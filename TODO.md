...
- Don't share configurations between production and development
...
- Migrate Redis nodes to node clusters (as originally intended)
  to make use of replica sets, backed by network isolation
